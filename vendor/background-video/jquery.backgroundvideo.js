...
(function($) {
  ...
  $.backgroundVideo = function(el, options) {
    ...
    var buildVideo = function () {
      ...
      if (_preload) {
        preloadString = 'preload="false"';
      } else {
        preloadString = '';
      }

      if (_autoplay) {
        autoplayString = 'autoplay="false"';
      } else {
        autoplayString = '';
      }

      if (_loop) {
        loopString = 'loop="false"';
      } else {
        loopString = '';
      }
      ...
      html += 'style="display:none;position:fixed;top:0;left:0;bottom:0;right:0;z-index:2;width:100%;height:100%;">';
